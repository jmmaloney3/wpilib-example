...
A lightweight guide for capturing robot requirements and mapping them to software work. This document is designed for both students and mentors working in a 6-week FRC build season.
...
Your robot needs to do things. Those things are **capabilities**. Your software needs to control hardware to make those capabilities happen. Here's how we connect the dots:
...
**Structure:** Use an indented bullet list. Start broad (high-level capabilities) and drill down to specific, actionable sub-capabilities.
